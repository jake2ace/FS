...
"""
    ...
    VERIFY_SYSTEM = (
        ...
        "are real differences. A missing value is uncertainty, not a mismatch. Report match true, false or "
        ...
        "missing_value for blank/invalid/ambiguous field values. Requests to send a draft BL with no "
        "attachments still NEEDS_REVIEW/missing_attachment.\n"
